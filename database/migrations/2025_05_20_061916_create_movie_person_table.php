...
/**
 * Class CreateMoviePersonTable
 *
 * Migration for creating the 'movie_person' pivot table to associate movies with individuals.
 */
class CreateMoviePersonTable extends Migration
{
     ...
     * Run the migrations.
     *
     * Creates the 'movie_person' table with foreign keys and role field.
     *
     * @return void
     */
