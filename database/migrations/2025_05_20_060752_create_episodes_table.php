    ...
    public function up(): void
    {
        Schema::create('episodes', function (Blueprint $table) {
            ...
            $table->foreignId('season_id')
                  ->constrained()
                  ->onDelete('cascade')
                  ->comment('Foreign key referencing the seasons table');
            ...
            $table->timestamp('created_at')->nullable()->comment('Timestamp for when the episode was created');
            $table->timestamp('updated_at')->nullable()->comment('Timestamp for when the episode was last updated');
        });
    }
